...
/datum/equipment_preset/clf/leader/load_gear(mob/living/carbon/human/new_human)
	...
	//jacket
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/marine/faction/royal_marine(new_human), WEAR_JACKET)
	//waist
	if(prob(75))
		new_human.equip_to_slot_or_del(new /obj/item/storage/backpack/general_belt/rmc(new_human), WEAR_WAIST)
	//limbs
...
/datum/equipment_preset/clf/commander/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(uniform, WEAR_BODY)
	//jacket
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/marine/faction/royal_marine/support_gunner(new_human), WEAR_JACKET)
	//waist
	if(prob(75))
		new_human.equip_to_slot_or_del(new /obj/item/storage/backpack/general_belt/rmc(new_human), WEAR_WAIST)
	//limbs
